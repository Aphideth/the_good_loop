        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-2/3 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h1 className="text-gray-900 mb-10 text-3xl title-font font-medium mb-1 ml-10">
                {brand.name}
              </h1>
              <p className="leading-relaxed mb-10">{brand.description}</p>
              {brand.criterias && Object.values(brand.criterias)[0] && (
                <>
                  <h2 className="font-medium italic uppercase mb-5 ml-10">
              ...
              {brand.weartypes && Object.values(brand.weartypes)[0] && (
                <>
                  ...
                  <div className="homefilter_block">
                    {Object.entries(brand.weartypes).map(
                      ([weartype, image]) => (
                        <Weartype
                          key={weartype.id}
                          weartype={{
